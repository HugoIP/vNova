...
</dir></dir></dir><input name="dan" id="dan" type="tex" readonly= "readonly" maxlength="100" placeholder=" ID" value=" <?php echo $dani; ?>">
	<label>Costo mensual</label>

<input name=" costo" type="text" maxlength="3" pattern="[0-9]+" placeholder="Costo" value=" <?php echo $daniel;?>"> 
	<label>   </label>
	<label>   </label>
	<label>   </label>
	<label>   </label>
